...
with gr.Blocks(theme=gr.themes.Default(primary_hue="sky")) as ui:
    ...
    answer_1 = gr.Textbox(label="Your Answer to Question 1")
    
    clar_q2 = gr.Textbox(label="Clarifying Question 2", interactive=False)
    answer_2 = gr.Textbox(label="Your Answer to Question 2")

    clar_q3 = gr.Textbox(label="Clarifying Question 3", interactive=False)
    answer_3 = gr.Textbox(label="Your Answer to Question 3")
